    ...
    if (maxNum.length === 2) {
      ...
      if (q > 0) {
        ...
        let b =
          str.replace(".", "") *
          Math.pow(10, maxNum[1].value.length - maxNum[0].value.length);
        return (a * 1 + b * 1) / Math.pow(10, maxNum[1].value.length);
      }
    } else {
      let a = maxNum[0].baseValue.replace(".", "");
      let b =
    ...
    if (maxNum.length === 2) {
      ...
      if (q > 0) {
        ...
        let b =
          str1.replace(".", "") *
          Math.pow(10, maxNum[0].value.length - maxNum[1].value.length);
        return (a * 1) * (b * 1) / Math.pow(10, maxNum[0].value.length * 2);
      } else if (q === 0) {
        let a = str.replace(".", "");
        let b = str1.replace(".", "");
        return (a * 1) * (b * 1) / Math.pow(10, maxNum[0].value.length * 2);
        ...
        let b =
          str.replace(".", "") *
          Math.pow(10, maxNum[1].value.length - maxNum[0].value.length);
        return (a * 1) * (b * 1) / Math.pow(10, maxNum[1].value.length * 2);
      }
    } else {
      let a = maxNum[0].baseValue.replace(".", "");
      let b =
...
exports.numDivide = numDivide;
exports.numMultiply = numMultiply;
exports.numSubtract = numSubtract;
